...
type DictationSettings struct {
	...
	VoiceType             string    `json:"voice_type"`              // 默认音色（保留兼容）
	ZhVoiceType           string    `json:"zh_voice_type"`           // 中文音色
	EnVoiceType           string    `json:"en_voice_type"`           // 英文音色
	DefaultEducationStage string    `json:"default_education_stage"` // 默认学段
	DefaultVersion        string    `json:"default_version"`         // 默认教材版本
	DefaultGrade          string    `json:"default_grade"`           // 默认年级
